...
#####          Direct Marketing Regression Analysis          #####
...
# Direct Marketing -- This dataset contains a variety of 
...
# model on the data, let's create indicator variables also known as "One-hot Encoding" 
# on the History column. Our base case will be when there is no recent history on the customer's purchases.
